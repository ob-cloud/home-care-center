...
<template>
  <div id="myAddress">
    ...
    <!-- 联系人 -->
    <van-address-list v-model="chosenAddressId" :list="shippingAddress" @add="onAdd" @edit="onEdit"
                      @select="onBackAddress" style="margin-top: 3rem" :add-button-text="$t('order.addLocation')"
    >
    </van-address-list>
    <!-- 路由出口 -->
